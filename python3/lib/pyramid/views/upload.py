    ...
    def post(self):
        ...
        for name, fieldStorage in self.request.POST.items():
            ...
            if self._validate(result):
                ...
                result['delete_type'] = self.DELETEMETHOD
                result['delete_url'] = self.request.route_url('upload') + '/' + result['name']
                result['url'] = 'needs_implementing' # self.request.route_url('comunity',)
